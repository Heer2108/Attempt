        ...
        <>
            {type === 'list-one' && (
                <Link
                    ...
                    as={"/blog/blog-detail/" + data?.slug}
                >
                    <div className="w-full md:w-1/2">
                        <div className="bg-img w-full overflow-hidden rounded-2xl"><Image width={2000} height={2000} className="w-full h-full block" src={data.img} alt={data.title} /></div>
                    </div>
                    <div className="w-full md:w-1/2">
                        ...
                        <div className="body3 text-secondary mt-4 pb-4">{data.ingress}</div>
                ...
                >
                    <div className="w-full">
                        <div className="bg-img w-full overflow-hidden rounded-2xl">
                            <Image width={500} height={500} className="w-full h-full block" src={data.img} alt={data.title} />
                        </div>
                        ...
                        <div className="heading6 mt-2">{data.title}</div>
                        <div className="body3 text-secondary mt-2 pb-4">{data.ingress}</div>
                        <div className="read font-bold underline">Read More</div>
                    </div>
                </Link>
            )}
                ...
                <div className="blog-item">
                    ...
                    >
                        <div className="bg-img w-full overflow-hidden">
                            <Image width={2000} height={2000} className="w-full h-full block" src={data.img} alt={data.title} />
                        </div>
