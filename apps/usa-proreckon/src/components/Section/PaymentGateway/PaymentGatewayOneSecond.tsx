                ...
                <div className="content flex items-center gap-8">
                    <div className="w-full xl:w-5/12 flex flex-col gap-y-6">
                        ...
                        <div className="body2 text-secondary">
                            ProReckon Solutions streamline your operations with expert outsourcing for accounting, valuation, and tax services. Whether you're a startup, a CPA firm, or an individual.
                        </div>
