                ...
                <ul className="sub-nav flex min-w-[65vw] absolute !-left-[380px] justify-around">
                  ...
                  <div>
                    ...
                    >
                      <Link
                        className="sub-nav-link font-medium"
                        href="/service/annual-tax-services/c-corporation-tax-returns"
                        onClick={() => setOpenMenuMobile(false)}
                      >
                    ...
                    <li
                      className={`sub-nav-item ${pathname === "/service/annual-tax-services/individual-tax-returns" ? "active" : ""}`}
                    >
                      <Link
                        className="sub-nav-link font-medium"
                        href="/service/annual-tax-services/individual-tax-returns"
                        onClick={() => setOpenMenuMobile(false)}
                      >
                  ...
                  <div>
                    ...
                    <li
                      className={`sub-nav-item ${pathname === "/service/sales-tax-services/vat-return-filing" ? "active" : ""}`}
                    >
                      <Link
                        className="sub-nav-link font-medium"
                        href="/service/sales-tax-services/vat-return-filing"
                        onClick={() => setOpenMenuMobile(false)}
                      >
                        VAT Return Filing
                      </Link>
